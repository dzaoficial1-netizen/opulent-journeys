...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Bespoke luxury travel — private villas, curated escapes, and concierge service across the world's most extraordinary destinations." },
